...
const exp = [{
    icon:'💼',
    title: '助理工程師',
    subtitle: '宏佳騰動力科技股份有限公司',
    range: '2025/11 – now',
    desc: '參與公司內部 <b>ERP</b> 系統之開發與維護，支援日常營運流程與跨部門作業需求，主要使用 <b>PowerBuilder</b> 進行系統功能開發與既有模組優化，依據實際業務流程進行需求分析與程式實作；同時負責系統異常排除與 <b>Bug 修復</b>，透過程式邏輯檢查與資料庫驗證確保系統穩定運行，並協助 <b>權限控管</b> 與系統帳號管理，提升整體系統安全性與使用效率。'
  },
  {
    icon:'🎓',
    title: '碩士',
  ...
  },
  {
    ...
    desc: '於大四實習參與公司內部系統轉換，負責以 <b>Genero</b> 獨立規劃並撰寫新採購系統，涵蓋報表輸出、資料處理及基礎管理模組。透過程式優化與流程重構提升系統效率，顯著減少人工作業時間，並展現需求分析與完整系統開發能力。'
  }, {
    icon:'🎓',
    title: '學士',
    subtitle: '國立屏東科技大學 資訊管理系',
